...
// Action movies
action.addEventListener('click', () => {
    showData(movies.filter(movie => movie.category === "Action"));
});

// Thriller movies
thriller.addEventListener('click', () => {
    showData(movies.filter(movie => movie.category === "Thriller"));
});

// Animation movies
animation.addEventListener('click', () => {
    showData(movies.filter(movie => movie.category === "Animation"));
});

// Horror movies
horror.addEventListener('click', () => {
    showData(movies.filter(movie => movie.category === "Horror"));
});

// Drama movies
drama.addEventListener('click', () => {
    showData(movies.filter(movie => movie.category === "Drama"));
});

// Sci-Fi movies
scifi.addEventListener('click', () => {
    showData(movies.filter(movie => movie.category === "Sci-Fi"));
});
